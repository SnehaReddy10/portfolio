...
export function Contact() {
  ...
  const sendEmail = (e) => {
    console.log('send', userEmail.current.value);
    e.preventDefault();
    emailjs
      .send(
  ...
  return (
    <div className="py-1 md:py-10 text-white mt-[2rem] md:mt-[5rem] bg-navy-blue dark:bg-black-900 w-[90vw] md:w-[35rem] p-1 md:p-5">
      <div className="flex flex-col md:flex-row justify-between">
        ...
        <form className="p-2 md:p-5 md:w-[50%] text-black">
          ...
          <button
            onClick={sendEmail}
            className="bg-green dark:bg-cyan m-1 p-1 w-[96%] text-[0.7rem] flex justify-center"
          >
            Send
          </button>
        </form>
